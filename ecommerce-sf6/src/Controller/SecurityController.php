...
class SecurityController extends AbstractController
{
    ...
    ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            if ($user) {
                ...
                // Je génére un lien de réinitialisation du mot de passe
                ...
                $this->addFlash('success', 'Email envoyé avec succé ');
    ...
    {
        // Je verifie ce j'ai ce token généré dans la base de données
        ...
        if ($user){
            ...
            if ($form->isSubmitted() && $form->isValid()){
                // J'efface le token on le remplacant par une chaine vide
                $user->setResetToken('');
                $user->setPassword(
                ...
                $this->addFlash('success', 'Votre mot de passe a été changé avec succé');
                return $this->redirectToRoute('app_login');
