...
class Coupons
{
    ...
    #[ORM\Column]
    private ?bool $is�_valid = null;

    #[ORM\Column(options: ['default => CURRANT_TIMESTAMP'])]
    ...
    public function isIs�Valid(): ?bool
    {
        return $this->is�_valid;
    }

    public function setIs�Valid(bool $is�_valid): self
    {
        $this->is�_valid = $is�_valid;
